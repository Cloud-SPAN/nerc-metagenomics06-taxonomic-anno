...
`kraken-biom` has many options which you can see with the help command. However, only need to specify an output format `--fmt` of `json` to use the file in the next step.
